...
<div class="wp-block-group stats-section has-background"
    ...
    <p class="has-text-align-center has-text-color has-link-color has-medium-font-size"
        ...
        <strong><?php esc_html_e( 'Our Services', 'feroz' ); ?></strong>
    </p>
    <!-- /wp:paragraph -->
    ...
    <h1 class="wp-block-heading has-text-align-center has-text-color has-link-color"
        style="color:#1f2937;margin-top:1rem"><strong><?php esc_html_e( 'Explore our range of professional services tailored to meet your
            business needs.', 'feroz' ); ?></strong></strong></h1>
    <!-- /wp:heading -->
    ...
    <p class="has-text-align-center has-text-color has-link-color has-sans-font-family has-medium-font-size"
        style="color:#1f2937;margin-bottom:4rem"><?php esc_html_e( 'We\'re committed to delivering solutions that elevate your brand and
        business goals.', 'feroz' ); ?></p>
    <!-- /wp:paragraph -->
    ...
    <div class="wp-block-group alignfull" style="margin-bottom:4rem">
        ...
        <div class="wp-block-columns">
            ...
            <div class="wp-block-column">
                ...
                <div class="wp-block-group stat-card">
                    ...
                    <h3 class="wp-block-heading has-text-align-center image-section has-text-color has-link-color has-medium-font-size"
                        style="color:#1f2937"><strong><?php esc_html_e( 'Customizable Settings', 'feroz' ); ?></strong>
                    </h3>
                    <!-- /wp:heading -->
                    ...
                    <p class="has-text-align-center has-text-color has-link-color has-small-font-size"
                        style="color:#4b5563;margin-top:0.75rem"><?php esc_html_e( 'Nibh nullam vitae semper pharetra sit enim id. Ut eu
                        non massa nec. Proin eget semper orci suspendisse.', 'feroz' ); ?></p>
                    <!-- /wp:paragraph -->
                </div>
                <!-- /wp:group -->
            </div>
            ...
            <div class="wp-block-column">
                ...
                <div class="wp-block-group stat-card">
                    ...
                    <!-- wp:heading {"textAlign":"center","level":3,"className":"image-section","style":{"color":{"text":"#1f2937"},"elements":{"link":{"color":{"text":"#1f2937"}}}},"fontSize":"medium"} -->
                    <h3 class="wp-block-heading has-text-align-center image-section has-text-color has-link-color has-medium-font-size"
                        style="color:#1f2937"><strong><?php esc_html_e( 'Developer-Friendly', 'feroz' ); ?></strong>
                    </h3>
                    <!-- /wp:heading -->

                    <!-- wp:paragraph {"align":"center","style":{"color":{"text":"#4b5563"},"elements":{"link":{"color":{"text":"#4b5563"}}},"spacing":{"margin":{"top":"0.75rem"}}},"fontSize":"small"} -->
                    <p class="has-text-align-center has-text-color has-link-color has-small-font-size"
                        style="color:#4b5563;margin-top:0.75rem"><?php esc_html_e( 'Sed et pulvinar donec sed et, nisl dolor amet. Mollis
                        aliquet volutpat ac sed lectus iaculis.', 'feroz' ); ?></p>
                    <!-- /wp:paragraph -->
                </div>
                <!-- /wp:group -->
            </div>
        ...
        <div class="wp-block-columns">
            ...
            <div class="wp-block-column">
                ...
                <div class="wp-block-group stat-card">
                    ...
                    <!-- wp:heading {"textAlign":"center","level":3,"className":"image-section","style":{"color":{"text":"#1f2937"},"elements":{"link":{"color":{"text":"#1f2937"}}}},"fontSize":"medium"} -->
                    <h3 class="wp-block-heading has-text-align-center image-section has-text-color has-link-color has-medium-font-size"
                        style="color:#1f2937"><strong><?php esc_html_e( 'Responsive Design', 'feroz' ); ?></strong></h3>
                    <!-- /wp:heading -->

                    <!-- wp:paragraph {"align":"center","style":{"color":{"text":"#4b5563"},"elements":{"link":{"color":{"text":"#4b5563"}}},"spacing":{"margin":{"top":"0.75rem"}}},"fontSize":"small"} -->
                    <p class="has-text-align-center has-text-color has-link-color has-small-font-size"
                        style="color:#4b5563;margin-top:0.75rem"><?php esc_html_e( 'Nunc amet, tempor morbi ligula ut faucibus gravida.
                        Accumsan, suspendisse mus quisque hendrerit.', 'feroz' ); ?></p>
                    <!-- /wp:paragraph -->
                </div>
                <!-- /wp:group -->
            </div>
            ...
            <div class="wp-block-column">
                ...
                <div class="wp-block-group stat-card">
                    ...
                    <!-- wp:heading {"textAlign":"center","level":3,"className":"image-section","style":{"color":{"text":"#1f2937"},"elements":{"link":{"color":{"text":"#1f2937"}}}},"fontSize":"medium"} -->
                    <h3 class="wp-block-heading has-text-align-center image-section has-text-color has-link-color has-medium-font-size"
                        style="color:#1f2937"><strong><?php esc_html_e( 'Cloud Integration', 'feroz' ); ?></strong></h3>
                    <!-- /wp:heading -->

                    <!-- wp:paragraph {"align":"center","style":{"color":{"text":"#4b5563"},"elements":{"link":{"color":{"text":"#4b5563"}}},"spacing":{"margin":{"top":"0.75rem"}}},"fontSize":"small"} -->
                    <p class="has-text-align-center has-text-color has-link-color has-small-font-size"
                        style="color:#4b5563;margin-top:0.75rem"><?php esc_html_e( 'Pellentesque auctor adipiscing lacus viverra. Arcu,
                        nibh purus urna amet sagittis quis tellus.', 'feroz' ); ?></p>
                    <!-- /wp:paragraph -->
                </div>
                <!-- /wp:group -->
            </div>
        ...
        <div class="wp-block-buttons"
            ...
            <div class="wp-block-button is-style-fill service-button">
                <a href="<?php echo esc_url(wp_login_url()); ?>"
                    ...
                    <?php echo esc_html__('Explore More', 'feroz'); ?>
                </a>
            </div>
            <!-- /wp:button -->
        </div>
